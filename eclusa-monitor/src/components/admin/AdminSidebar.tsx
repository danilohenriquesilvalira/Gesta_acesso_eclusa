    ...
    >
      ...
      <div className="px-6 py-6 shrink-0" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-extrabold text-[13px] leading-tight">Controlo</p>
            <p className="font-bold text-[11px] leading-none mt-0.5" style={{ color: "#28FF52" }}>NEXT Admin</p>
          </div>
        </div>
      </div>
            ...
            {items.map(({ id, label, icon }) => {
              ...
              return (
                <button key={id} onClick={() => onPagina(id)}
                  className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl mb-0.5 text-[13px] font-semibold cursor-pointer transition-all"
                  style={{
                    background:  ativo ? "rgba(40,255,82,0.1)" : "transparent",
                    color:       ativo ? "#28FF52" : "rgba(255,255,255,0.55)",
                    borderLeft:  ativo ? "2px solid #28FF52" : "2px solid transparent",
                  }}
                  onMouseEnter={e => { if (!ativo) (e.currentTarget as HTMLButtonElement).style.background = "rgba(255,255,255,0.05)"; }}
      ...
      <div className="shrink-0 p-3" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        <div className="flex items-center gap-3 px-3 py-3 rounded-xl mb-1"
          ...
          <div className="w-8 h-8 rounded-full flex items-center justify-center font-extrabold text-[13px] shrink-0"
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] font-semibold leading-none mt-0.5" style={{ color: "#28FF52" }}>Administrador</p>
          </div>
        </div>
